...
const SingleApp = ({ singleData }) => {
  const { description, title, image, ratingAvg, downloads ,id} = singleData;
  return (
  ...
  hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]"
      >
        ...
        <div className="flex justify-between items-center text-xs">
          {/* Downloads */}
          <span className="flex gap-3 items-center bg-green-100 text-green-600 px-2 py-1 rounded-md transition hover:scale-105">
