...
const AppDetails = () => {
  ...
  const handleDownload = (id) => {
    addToStoredDB(id);
    toast("Successfully Install Done!");
  };
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <button
              ...
              className="btn bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-2 rounded font-medium transition-colors text-sm"
            >
              Install Now ({size})
            </button>
            <ToastContainer />
        ...
        <div>
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            ...
            <p>
              ...
              motivational streaks and achievements. Whether you're studying for
              exams, coding, writing, or handling office work, the app adapts to
              your routine.
            </p>
          </div>
        </div>
